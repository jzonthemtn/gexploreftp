...
namespace gExploreFTP.FTP.FtpServer
{
	...
	class FtpSocketHandler
	{
        ...
        public FtpSocketHandler(FileSystem.Interfaces.IFileSystemClassFactory fileSystemClassFactory, int nId)
		{
			m_nId = nId;
		...
		public void Start(System.Net.Sockets.TcpClient socket)
		{
            ...
            m_theCommands = new gExploreFTP.FTP.FtpServer.FtpConnectionObject(m_fileSystemClassFactory, m_nId, socket);
