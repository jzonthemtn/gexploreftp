...
namespace gExploreFTP.FTP.FtpServer
{
	...
	public class FtpServer
	{
        ...
        private FileSystem.Interfaces.IFileSystemClassFactory m_fileSystemClassFactory = null;
        ...
        public FtpServer(FileSystem.Interfaces.IFileSystemClassFactory fileSystemClassFactory)
		{

            // Open the database.
            //gExploreFTP.FTP.Custom.Database.MakeAndOpenDatabase();
		...
		public void Stop()
		{
            ...
            FtpServerMessageHandler.SendMessage(0, "gExploreFTP stopped.");
		...
		{
            m_socketListen = gExploreFTP.FTP.General.SocketHelpers.CreateTcpListener(m_nPort);

			if (m_socketListen != null)
			{			
				m_socketListen.Start();

				FtpServerMessageHandler.SendMessage(0, "gExploreFTP started.");
			...
			{
				FtpServerMessageHandler.SendMessage(0, "Error starting gExploreFTP.");
			}
		}

		private void SendAcceptMessage(System.Net.Sockets.TcpClient socket)
		{
            gExploreFTP.FTP.General.SocketHelpers.Send(socket, System.Text.Encoding.ASCII.GetBytes("220 FTP Server Ready\r\n"));
		}
		...
		private void InitialiseSocketHandler(System.Net.Sockets.TcpClient socket)
		{
            ...
            handler.Closed += new gExploreFTP.FTP.FtpServer.FtpSocketHandler.CloseHandler(handler_Closed);
