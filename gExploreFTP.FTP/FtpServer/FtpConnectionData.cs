...
namespace gExploreFTP.FTP.FtpServer
{
	...
	class FtpConnectionData
	{
        ...
        private FileSystem.Interfaces.IFileSystem m_fileSystem = null;
		...
		public FileSystem.Interfaces.IFileSystem FileSystemObject
		{
			get
			{
				return m_fileSystem;
		...
		protected void SetFileSystemObject(FileSystem.Interfaces.IFileSystem fileSystem)
		{
